...
const oldPeople = inventors.filter(({ year }) => year >= 1500 && year < 1600)
...
const sortedAge = inventors.sort((a, b) => a.year - b.year)
...
const sortedLived = inventors.sort((a, b) => a.passed - a.year < b.passed - b.year)
...
const peopleAsc = people.sort(
  (a, b) => a.split(", ")[1].charAt(0) > b.split(", ")[1].charAt(0)
)
